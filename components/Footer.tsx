    ...
    <footer className="border-t border-[var(--color-ink)]/10 bg-[var(--color-card)]">
      <div className="mx-auto max-w-7xl px-6 py-12 sm:px-10">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-4">
          <div>
            <h3 className="font-[family-name:var(--font-fraunces)] text-lg text-[var(--color-ink)]">SMK Market</h3>
        ...
        <p className="mt-10 text-xs text-[var(--color-ink)]/50">(c) 2026 SMK Market</p>
      </div>
    </footer>
  )
}